...
LF-CNN for OPM Classification, based on the paper:

Wen, T., Zhang, Z., & Li, J. (2018). Adaptive neural network classifier for
decoding MEG signals. Journal of neuroscience methods, 308, 1-9.
"""
